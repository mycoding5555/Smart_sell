...
insert into public.products (name, slug, description, price, discount_price, category, images, barcode, sku, featured, stock)
values
  ('Rosé Hydrating Toner', 'rose-hydrating-toner', 'Soothing rose-infused toner for sensitive skin.', 18.00, 14.50, 'skincare',
   array['https://images.unsplash.com/photo-1556228720-195a672e8a03?w=800'], '8851234500011', 'SKU-TONER-01', true, 50),

  ('Velvet Matte Lipstick — Nude', 'velvet-matte-lipstick-nude', 'Long-wear matte lipstick in warm nude.', 12.50, null, 'makeup',
   array['https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=800'], '8851234500028', 'SKU-LIP-01', true, 30),

  ('Silk Touch Eau de Parfum', 'silk-touch-edp', '50ml floral musky perfume.', 45.00, 39.00, 'perfume',
   array['https://images.unsplash.com/photo-1541643600914-78b084683601?w=800'], '8851234500035', 'SKU-PERF-01', true, 20),

  ('Argan Repair Hair Mask', 'argan-repair-hair-mask', 'Deep-conditioning weekly treatment.', 22.00, null, 'haircare',
   array['https://images.unsplash.com/photo-1522338242992-e1a54906a8da?w=800'], '8851234500042', 'SKU-HAIR-01', false, 25),

  ('Coconut Body Butter', 'coconut-body-butter', 'Whipped body butter, 200g.', 16.00, 12.80, 'bodycare',
   array['https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?w=800'], '8851234500059', 'SKU-BODY-01', true, 40)
